import { calculadora } from "./calculadora.mjs";/*Llamamos al archivo calculadora para acceder a sus funciones, en ES6 usamos import, en el modo viejo usamos un const y un require*/
const c = console.log;
